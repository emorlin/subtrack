...
| **Prishistorik** | Spåra prisändringar bakåt i tiden — se exakt vad du betalat sedan starten. Lägg till, redigera och ta bort prisposter direkt i detaljvyn med penna- och papperskorgsikonerna |
...
| **Inbyggd användarguide** | Under "Om appen" i navigationen finns en Användarguide-flik som förklarar alla funktioner ur ett användarperspektiv — steg för steg hur man lägger till abonnemang, förstår prishistorik, tolkar stapeldiagrammet och ställer in påminnelser. Standardflik vid öppning. Fliken "Teknisk info" innehåller arkitektur och databasmodell |
